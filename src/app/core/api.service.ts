...
import * as  AppUtils from '../shared/components/comum/app.utils';
...
export class ApiService {
  ...
  login(user): Observable<any> {
    ...
    const options = {
      headers: AppUtils.HEADERS_COMUN,
      params
    }
  ...
  registerUser(user: UserDTO): Observable<any> {
    return this.httpClient.post(AppUtils.REGISTER_URL, user, { headers: AppUtils.HEADERS_COMUN });
  ...
  getUsers(): Observable<any> {
    return this.httpClient.get(`${this.baseUrl}`, AppUtils.OPTIONS_OBJECTO);
  }
  ...
  logout():Observable<any>{
    return this.httpClient.get<any>(`${this.baseUrl}/api/logout`, AppUtils.OPTIONS_OBJECTO);
  }
}
